<div class="modal fade" id="editar-funcionario-modal" tabindex="-1" aria-labelledby="editar-funcionario-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-cad-funcionario modal-dialog-centered modal-md">
        <div class="modal-content">
            ...
            <div class="form">
                <form action="{{ route('funcionario.update') }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="input input-nome-funcionario">
                        <label for="nome_funcionario">Nome</label>
                        <input type="text" oninput="validaInput(this)" name="nome_funcionario" id="nome-funcionario" placeholder="José da Silva" maxlength="100" required>
                    </div>
                    ...
                    <div class="input input-endereco">
                        ...
                        <input type="text" oninput="validaInput(this)" name="endereco_completo" id="endereco" placeholder="Rua dos Cocais, num 25 Bairro Centro, Espinosa-MG" maxlength="100" required>
                    </div>
                    ...
                    <input type="hidden" name="id_funcionario" id="id-funcionario">
